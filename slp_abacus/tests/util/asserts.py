...
from slp_abacus.tests.util.builders import DEFAULT_TRUSTZONE
...
def assert_parents(components: [AbacusComponent], relationships: dict = None):
    for component in components:
        assert_parent(component=component, parent_id=relationships.get(component.id))


def assert_parent(component: AbacusComponent, parent_id: str = None):
    if parent_id:
