...
class abacusLoader(ProviderLoader):
    ...
    def __map_abacus_to_resources(self):
        resources = abacusToResourceDict(self.__get_abacus_resources()).map_modules(self.__get_abacus_root_module())
    ...
    def __map_abacus_to_variables(self):
        variables = self.__get_abacus_variables()
        if variables:
