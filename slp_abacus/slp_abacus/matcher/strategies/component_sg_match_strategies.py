...
from slp_abacus.slp_abacus.objects.abacus_objects import SecurityGroup, AbacusComponent
...
class ComponentMatchStrategySecurityGroupByGraphStrategy(MatchStrategy):
    ...
    def are_related(self, component: AbacusComponent, security_group: SecurityGroup, **kwargs) -> bool:
