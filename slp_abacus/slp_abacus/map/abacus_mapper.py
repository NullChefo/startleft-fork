...
from slp_abacus.slp_abacus.map.mapping import Mapping, TrustZoneMapping, ComponentMapping
...
class AbacusMapper:
    ...
    def __init__(self, otm: AbacusOTM, abacus: {}, mapping: Mapping):
        self.otm = otm
    ...
    def map(self):
        self.otm.components = self.__abacus_resources_to_otm_components()
        self.otm.trustzones = [self.default_trustzone]

    def __abacus_resources_to_otm_components(self) -> []:
        components = []
    ...
    def __map_resource_by_mapping_components(self, resource: dict) -> AbacusComponent:
    ...
    def __map_resource_by_catch_all(self, resource: dict) -> AbacusComponent:
    ...
    def __build_otm_component(self, resource: {}, component: ComponentMapping) -> AbacusComponent:
