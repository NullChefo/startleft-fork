...
@auto_repr
class AbacusComponent(Component):
    ...
    def __eq__(self, other):
        ...
        if isinstance(other, AbacusComponent):
...
class AbacusOTM(OTM):
    ...
    def __init__(self,
                 project_id: str,
                 project_name: str,
                 components: List[AbacusComponent],
    ...
    def get_component_by_id(self, c_id: str) -> AbacusComponent:
